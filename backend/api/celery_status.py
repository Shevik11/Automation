...
async def check_celery_status(current_user: User = Depends(get_current_user)):
    """
    ...
    return {
        ...
        "celery_worker": {
            ...
            "registered_tasks": (
                list(registered_workers.values())[0] if registered_workers else []
            ),
        },
    }
...
async def get_celery_tasks(current_user: User = Depends(get_current_user)):
    """
