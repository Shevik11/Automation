...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_workflow_configs_id"), "workflow_configs", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_workflow_configs_user_id"),
        "workflow_configs",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["workflow_config_id"], ["workflow_configs.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(op.f("ix_saved_presets_id"), "saved_presets", ["id"], unique=False)
    op.create_index(
        op.f("ix_saved_presets_user_id"), "saved_presets", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_saved_presets_workflow_config_id"),
        "saved_presets",
        ["workflow_config_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_workflow_executions_n8n_execution_id"),
        "workflow_executions",
        ["n8n_execution_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_workflow_executions_workflow_config_id"),
        "workflow_executions",
        ["workflow_config_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_linkedin_results_id"), "linkedin_results", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_linkedin_results_workflow_execution_id"),
        "linkedin_results",
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_linkedin_results_workflow_execution_id"), table_name="linkedin_results"
    )
    ...
    op.drop_index(
        op.f("ix_saved_presets_workflow_config_id"), table_name="saved_presets"
    )
    ...
    op.drop_index(
        op.f("ix_workflow_configs_n8n_workflow_id"), table_name="workflow_configs"
    )
